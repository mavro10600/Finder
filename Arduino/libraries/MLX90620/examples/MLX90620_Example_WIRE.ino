/*
 ...
 National Autonomous University of México
	...
	César Pineda
This code is an adapation of Nathan Seidle from  Spark Fun Electronics. Here I exchange i2cmaster library to Wire library. 
...
void read_EEPROM_MLX90620(){
	Wire.beginTransmission(MLX90620_EEPROM_WRITE);
