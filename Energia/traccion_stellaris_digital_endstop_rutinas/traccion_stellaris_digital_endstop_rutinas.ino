...
if(flipper1_out>64){fl1_stat=true;}
if(flipper1_out<64){fl1_stat=false;}
if(flipper2_out>64){fl2_stat=true;}
if(flipper2_out<64){fl2_stat=false;}
if(flipper3_out>64){fl3_stat=true;}
if(flipper3_out<64){fl3_stat=false;}
if(flipper4_out>64){fl4_stat=true;}    
if(flipper4_out<64){fl4_stat=false;}
}
...
if (endstp1==true)
{
  ...
  if(fl1_stat==false){if(flipper1_out>64){roboclaw.ForwardBackwardM1(address,flipper1_out);}else {roboclaw.ForwardBackwardM1(address,64);}}
  if(fl1_stat==true){if(flipper1_out<64){roboclaw.ForwardBackwardM1(address,64);}else {roboclaw.ForwardBackwardM1(address,flipper1_out);}}
}
...
{
  //roboclaw.ForwardBackwardM1(address,64);
  if(fl2_stat==true){if(flipper2_out<64){roboclaw.ForwardBackwardM2(address,flipper2_out);}else {roboclaw.ForwardBackwardM2(address,64);}}
